...
//
//        Advancement root = Advancement.Builder.advancement().display(BLOCKS.get(ID_TINKER_BENCH), Component.translatable("advancements.thermal.root.title"), Component.translatable("advancements.thermal.root.description"), ResourceLocation.parse("thermal:textures/gui/advancements/backgrounds/blueprint.png"), FrameType.TASK, false, false, false).addCriterion("has_tinker_bench", InventoryChangeTrigger.TriggerInstance.hasItems(BLOCKS.get(ID_TINKER_BENCH))).save(advancementConsumer, "thermal:root");
//        Advancement wrench = Advancement.Builder.advancement().parent(root).display(ITEMS.get(ID_WRENCH), Component.translatable("advancements.thermal.wrench.title"), Component.translatable("advancements.thermal.wrench.description"), null, FrameType.TASK, true, true, false).addCriterion("has_wrench", InventoryChangeTrigger.TriggerInstance.hasItems(ITEMS.get("wrench"))).save(advancementConsumer, "thermal:wrench");
//    }
//
//}
